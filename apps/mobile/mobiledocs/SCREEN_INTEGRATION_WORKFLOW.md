...
onboarding sprint ([`DECISIONS.md`](DECISIONS.md) D-19 to D-27) and formalized here for the authentication sprint
...
Read the relevant `.md` files before touching any code: [`AGENT_INSTRUCTIONS.md`](../../../appdocs/AGENT_INSTRUCTIONS.md),
[`PRODUCT_CONTEXT.md`](../../../appdocs/product/PRODUCT_CONTEXT.md), [`MVP_SCOPE.md`](../../../appdocs/product/MVP_SCOPE.md), [`UX_SCREENS_AND_FLOWS.md`](../../../appdocs/product/UX_SCREENS_AND_FLOWS.md), [`THEME_AND_I18N.md`](../../../appdocs/design/THEME_AND_I18N.md),
[`DESIGN_SYSTEM.md`](../../../appdocs/design/DESIGN_SYSTEM.md), [`DECISIONS.md`](DECISIONS.md), [`CONVENTIONS.md`](CONVENTIONS.md) and the feature document in [`features/`](features/). They are the source of truth; if a document is
stale, check the code before changing the doc (see [`AGENT_INSTRUCTIONS.md`](../../../appdocs/AGENT_INSTRUCTIONS.md)).
...
- what the states in [`UX_SCREENS_AND_FLOWS.md`](../../../appdocs/product/UX_SCREENS_AND_FLOWS.md) → "Important states" imply for this screen
...
crop is acceptable, **only if documented as temporary** (see [`apps/mobile/assets/images/onboarding/README.md`](../assets/images/onboarding/README.md) and
[`apps/mobile/assets/images/auth/README.md`](../assets/images/auth/README.md) for the pattern) — a short README next to the asset naming what's temporary
...
- Typography goes through `<Text variant="…">`; never set a font family/size by hand except for a
  ...
  and onboarding titles do — record it in [`DECISIONS.md`](DECISIONS.md) if it introduces something new).
...
- Every screen considers loading / empty / error / success states where the UX doc calls for them, even
  in a front-end-only prototype (see [`AGENT_INSTRUCTIONS.md`](../../../appdocs/AGENT_INSTRUCTIONS.md) → "Definition of done").
...
that isn't built yet in this sprint, add a minimal placeholder screen/route ([`DECISIONS.md`](DECISIONS.md) D-20, D-29,
...
Navigation checklist ([`NAVIGATION.md`](NAVIGATION.md#native-back-gesture) → "Native back gesture", [`DECISIONS.md`](DECISIONS.md) D-53):
...
- the feature document in [`features/`](features/) — new route(s)/screen in the relevant table; [`CONVENTIONS.md`](CONVENTIONS.md) — new convention if one was introduced;
- [`DECISIONS.md`](DECISIONS.md) — a new entry for any non-obvious choice (temporary asset, a design token change, a
  navigation choice not shown in the mockup…), following the existing numbering;
- [`ROADMAP.md`](../../../appdocs/ROADMAP.md) — check off the screen once it is done;
- [`README.md`](README.md) — the "Current state" table if the sprint's overall state changed.
