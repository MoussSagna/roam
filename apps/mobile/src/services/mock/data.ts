...
export const experiences: Experience[] = [
  ...
  // Hero carousel (Home, top of screen) — 5 featured experiences.
  {
    ...
    location: 'Paris',
    coordinates: { latitude: 48.8639, longitude: 2.3128 },
  ...
  },
  {
    ...
    location: 'Paris',
    coordinates: { latitude: 48.86, longitude: 2.3266 },
  ...
  // Most popular experiences (Home).
  {
    ...
    images: buildGallery(heroCafe),
    location: 'Paris',
    coordinates: { latitude: 48.8752, longitude: 2.3555 },
  ...
  },
  {
    ...
    location: 'Paris',
    coordinates: { latitude: 48.8606, longitude: 2.3522 },
  ...
  },
  {
    ...
    images: buildGallery(heroNightParis),
    location: 'Paris',
    coordinates: { latitude: 48.882, longitude: 2.3325 },
  ...
  },
  {
    ...
    images: buildGallery(heroLandscape),
    location: 'Paris',
    coordinates: { latitude: 48.8656, longitude: 2.4008 },
    distanceLabel: '3,1 km',
    durationLabel: '2 h',
    priceLabel: '22 €',
    rating: 4.4,
