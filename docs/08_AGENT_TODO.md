...
- [~] Authentication screens — **front-end only, simulated** (Login, Register, Forgot password + their states). Entry, Login, Register, Forgot password, its reset-code and new-password steps done; the success screen ending the forgot-password sub-flow is next — see `DECISIONS.md` D-28, D-29, D-31–D-35 and `docs/SCREEN_INTEGRATION_WORKFLOW.md`
- [ ] Context flow
