...
- [~] Authentication screens — **front-end only, simulated** (Login, Register, Forgot password + their states). Entry, Login, Register, Forgot password and its reset-code step done; new-password/success screens of the forgot-password sub-flow are next — see `DECISIONS.md` D-28, D-29, D-31–D-34 and `docs/SCREEN_INTEGRATION_WORKFLOW.md`
- [ ] Context flow
