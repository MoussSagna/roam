...
- **Components built so far:** `Text`, `Button` (primary, secondary; 48 px touch target), `Chip`,
  `Screen`, `FadeInUp`, `Logo`. None of the "Core" components of this document beyond `Button` and
