...
| Piece                      | Route / component                                                                        | Notes                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------------- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Main screen                | `/profile` (in `(tabs)`) → `features/profile/ProfileScreen.tsx`                          | Header (avatar/name/bio/edit CTA), stats, "Parcours en cours", "Ce que j'aime", favorites/history previews, yearly activity summary — built on `UserRepository` (`useCurrentUser`) plus the hooks below, `docs/DECISIONS.md` D-63                                                                                                                                                            |
