...
only and simulated: Entry, Login, Register, Forgot password, its reset-code and new-password steps are done;
the success screen ending that sub-flow is next — see `DECISIONS.md` D-28, D-29, D-31–D-35, `08_AGENT_TODO.md`
and `docs/SCREEN_INTEGRATION_WORKFLOW.md`.
