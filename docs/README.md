...
only and simulated: the entry screen (`/auth`) is done, Login/Register/Forgot password are next — see
`DECISIONS.md` D-28, D-29, `08_AGENT_TODO.md` and `docs/SCREEN_INTEGRATION_WORKFLOW.md`.
