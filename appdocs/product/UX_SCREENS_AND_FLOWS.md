...
screens are the next front-end step, simulated (no backend) — see [`DECISIONS.md`](../../apps/mobile/mobiledocs/DECISIONS.md) D-28.
...
"Prêt à explorer ?" by itself. See [`DECISIONS.md`](../../apps/mobile/mobiledocs/DECISIONS.md) D-27.
